  ...
  const content = `
      <div class="content">
        ...
        <p class="action">
          ...
          <a class="button" href="${process.env.APP_BASE_URL}/expired" target="_blank">First Aid Kit</a>
        </p>
        </div>`;
...
export const missingMedicinesTemplate = (missingMedicines: TConstantlyStoredMedicine[]) => {
  const content = `
      <div class="content">
        ...
        <p class="action">
          Click the button below to remove expired medicines:
          <a class="button" href="${process.env.APP_BASE_URL}/must-have" target="_blank">First Aid Kit</a>
        </p>
        </div>`;
